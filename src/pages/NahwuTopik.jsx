      ...
      <div className="h-full min-h-screen mt-0 pt-2 w-full">
        <div className="bg-white rounded-l-3xl min-h-[98.75vh] h-full pt-5 pl-4 pr-4">
          <div className="rounded-xl flex flex-col p-2 mb-4 ml-2">
            <p className="text-dark-cyan text-2xl font-semibold">Topik</p>
            <p className="text-sm">
              Anda dapat mengelola materi, kuis, ujian dan pembahasan.
            </p>
            <div className="flex items-center">
              <a href={`/nahwu/${kategoriMateri}`} className="text-[#6D6D6D] text-sm">
                Nahwu
              </a>
              <PlayArrowIcon
                style={{ fontSize: "16px" }}
              ...
              />
              <a href={`/nahwutopik/${id}`} className="text-dark-cyan text-sm font-medium">
                Topik
              </a>
            </div>
          </div>
